...
export default function PlaceholderImage({ className = "", label = "Image Placeholder" }: PlaceholderImageProps) {
  return (
    <div className={`relative overflow-hidden bg-white/5 border border-white/10 flex items-center justify-center group ${className}`}>
      ...
      <div className="relative z-10 flex flex-col items-center gap-3 text-gray-500 group-hover:text-emerald-500 transition-colors duration-500">
        ...
        <span className="text-xs font-medium tracking-widest uppercase opacity-60">{label}</span>
      </div>
