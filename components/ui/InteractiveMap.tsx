      ...
      {locations.map((loc) => (
        ...
        >
          <div className="relative -translate-x-1/2 -translate-y-1/2">
             {/* Node Dot */}
            <div className={`w-3 h-3 rounded-full transition-colors duration-300 ${hoveredCity === loc.name ? "bg-emerald-400 shadow-[0_0_15px_rgba(52,211,153,0.8)]" : "bg-emerald-500/50 shadow-[0_0_10px_rgba(16,185,129,0.3)]"}`} />
            ...
            <motion.div 
                ...
                animate={{ opacity: hoveredCity === loc.name ? 1 : 0, y: hoveredCity === loc.name ? -35 : 10 }}
